...
static int audio_init_ain(enSDK_AUDIO_SAMPLE_RATE sample_rate, int sample_width, int type)
{
    ...
    stAoVqeAttr.u32OpenMask =	AO_VQE_MASK_AGC | AO_VQE_MASK_ANR | AO_VQE_MASK_EQ | AO_VQE_MASK_HPF;//HI_TRUE;
	...
	stAoVqeAttr.stAnrCfg.s16NrIntensity = 15;
	stAoVqeAttr.stAnrCfg.s16NoiseDbThr	= 60;

  //  stAoVqeAttr.bAgcOpen = HI_FALSE;
	stAoVqeAttr.stAgcCfg.bUsrMode		= HI_TRUE;
	stAoVqeAttr.stAgcCfg.s8TargetLevel	= -2;
	stAoVqeAttr.stAgcCfg.s8NoiseFloor	= -40;
	stAoVqeAttr.stAgcCfg.s8MaxGain		= 30;
	stAoVqeAttr.stAgcCfg.s8AdjustSpeed	= 1;
	stAoVqeAttr.stAgcCfg.s8ImproveSNR	= 2;
	stAoVqeAttr.stAgcCfg.s8UseHighPassFilt = 3;
	stAoVqeAttr.stAgcCfg.s8OutputMode	= 1;
...
*/
	stAiVqeTalkAttr.u32OpenMask =   AI_TALKVQE_MASK_ANR | AI_TALKVQE_MASK_AGC;
	//stAiVqeTalkAttr.u32OpenMask =  AI_TALKVQE_MASK_ANR ;
	//stAiVqeTalkAttr.u32OpenMask =  0 ;
