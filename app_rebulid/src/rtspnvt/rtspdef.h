...
#define MINRTSP_MODULE	"MINIRTSP"

//#define MINIRTSP_HAVE_CLIENT
#define MINIRTSP_HAVE_SERVER

/**************************************************************************
* configure mirco
**************************************************************************/
#define RTSP_SOCK_TIMEOUT			(10000) //  unit: ms , socket send and receive timeout
