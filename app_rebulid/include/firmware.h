...
extern uint32_t FIRMWARE_import_check(char *soc, int *ret_errno, bool downgrade);
...
extern int FIRMWARE_upgrade_start(int need_reboot, bool downgrade);
...
extern int FIRMWARE_upgrade_import_check(bool downgrade);
