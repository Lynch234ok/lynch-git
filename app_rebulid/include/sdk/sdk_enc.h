...
typedef struct _SoupFrameHead{
    unsigned int magic;         /* magic number πÃ∂®Œ™ 0x534f55ff , "SOU°§" */
    unsigned int version;       /* ∞Ê±æ–≈œ¢£¨µ±«∞∞Ê±æŒ™1.0.0.0£¨πÃ∂®Œ™0x01000000*/
    unsigned int frametype;     /* ¬Î¡˜÷°¿‡–Õ£¨µ±«∞∞Ê±æ÷ß≥÷»˝÷÷¿‡–Õ£∫0x00--“Ù∆µ 0x01-- ”∆µI÷° 0x02-- ”∆µP÷° */
    unsigned int framesize;     /* ¬Î¡˜÷°µƒ¬„ ˝æ›≥§∂» */
    /*
     *  ÷° ±º‰¥¡£¨64Œª ˝æ›£¨æ´∂»µΩŒ¢√Î
     *  ¿˙ ∑‘≠“Ú£¨’‚∏ˆpts÷±Ω” π”√µƒstruct timeval,Client Ω‚Œˆ ±sec/usec”÷∑¥π˝¿¥¡À
     *  À˘“‘”–“‘œ¬–Œ Ωµƒ¡™∫œÃÂ
     *  union{
     *      JaInt64 pts;
     *      struct {
    ...
    unsigned int ts_usec;
    unsigned int ts_sec;
    unsigned int externsize; /* ¿©’π ˝æ›¥Û–°£¨µ±«∞∞Ê±æŒ™0 */
    union{
        /*  ”∆µøÌ°¢∏ﬂ ±‡¬Î£¨ ascii "H264" */
        struct {
            unsigned int width;
        ...
        /* “Ù∆µ≤…—˘¬ £¨ŒªøÌ£¨ G711<orz ÷ª”–ÀƒŒª∑≈≤ªœ¬g711a> */
        struct {
